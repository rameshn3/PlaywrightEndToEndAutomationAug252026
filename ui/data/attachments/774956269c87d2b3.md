...
- Name: saucedemo/cartpage.spec.ts >> Cart page tests >> click on continue shopping button and verify navigation to product page
- Location: tests/saucedemo/cartpage.spec.ts:25:7
